<template>
    <div class="cat-new-wrapper mt-5">
        ...
        <form class="w-25 mx-auto" @submit.prevent="editArticle()">
...
export default {
  ...
  methods: {
    ...
    async fetchArticle(id){
        ...
        this.userName = article.author;
        this.createdAt = article.createdAt;
        this.category = article.categoryId;

        console.log(article.tagIds)
        for(let i = 0 ; i < article.tagIds.length; i++){
            this.addedTags.push(this.getTagById(article.tagIds[i]));
        }
